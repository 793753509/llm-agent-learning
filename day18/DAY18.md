...
| capstone/api.py | 复用 Day 17 的 HTTP 接口 |
| day07/knowledge.json | 北店/南店教学资料，项目固定选北店 |
| day11/server.py | 真正的 MCP 服务端 |
| day10/approval.py | 草稿、checkpoint、恢复和本地唯一写入 |
| day20/verify.py | 一键验收真实执行结果 |
...
示例已放在 `day18/design/decisions.md`。
...
4. `acceptance.md`：把验收动作对应到 Day 20 的检查。
