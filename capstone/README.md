...
最后一条运行本地验收，报告见 [local.md](../day20/reports/local.md)。
每次以你本次成功执行后写出的报告为准。
...
代码复用 Day 07、10、11、12、14、15、17 的模块。完整设计见 [Day 18](../day18/DAY18.md)。
...
演示见 [五分钟脚本](../day21/demo.md)，自测见 [面试问答](../day21/interview.md)。
